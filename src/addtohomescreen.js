    ...
    */
    ...
    ath.intl = {
        de_de: {
            ...
            windows: 'To add this web app to your start screen: tap the %icon and then <strong>pin to start</strong>.',
        },
    ...
    _extend(ath, {
        ...
        isIDevice: (/iphone|ipod|ipad/i).test(_ua) && _ua.indexOf('Trident') === -1,
    ...
    ath.isStandalone = window.navigator.standalone || (ath.isMobileChrome && (screen.height - document.documentElement.clientHeight < 40)) || (ath.isMobileIE && window.external.msIsSiteMode());	// TODO: check the lame polyfill
    ...
    ath.Class = function (options) {
        ...
        this.options.mandatory = this.options.mandatory && ('standalone' in window.navigator || this.options.debug); // TODO: Add window.external.msIsSiteMode ?
